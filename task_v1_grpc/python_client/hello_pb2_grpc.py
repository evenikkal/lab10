...
def add_GreeterServicer_to_server(servicer, server):
    ...
    from grpc import method_service_handler as _method_service_handler
    rpc_method_handlers = {
        'SayHello': unary_unary(
            servicer.SayHello,
            request_deserializer=hello__pb2.HelloRequest.FromString,
            response_serializer=hello__pb2.HelloReply.SerializeToString,
        ),
    }
    generic_handler = grpc.method_service_handler('hello.Greeter', rpc_method_handlers)
